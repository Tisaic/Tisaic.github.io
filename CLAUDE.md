...
1.27x**, same code, same fit, one plant constant; saturation is not the mechanism (0.0% of samples
clipped at every bench row). So §52.26's limit is REAL AND LOCAL: on the bench cell there is no

...
one plant. **AND THE FIELD IS NOW THREE ADMISSIBLE RIVALS RATHER THAN ONE (plan §56, §110)** —
...
8. **MEASURED AGAINST SOMETHING THAT IS NOT US. ONE LITERATURE METHOD IS NOW BUILT AND RUN,
   ...
   **AND KOOPMAN-EDMD IS NOW BUILT, WHICH MAKES IT THREE — BUT IT IS TWO OBJECTS AND ONLY ONE OF THEM
   IS A RIVAL (plan §110).** The literature's Koopman CONTROLLER lifts the MEASURED STATE and solves an
   ...
   **It diverges at every setting**, its best move on this plant is not to move, and the sweep is
   ...
   shipped object and to survive the noise falsifier (plan §110). THREE methods on ONE axis are still
   not a field.**

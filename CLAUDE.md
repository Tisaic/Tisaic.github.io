...
1. **PROGRAM-AGNOSTIC. MEASURED ON SEVEN PLANTS FOR THE FIRST TIME, AND MET ON FOUR (plan §88).**
   ...
   **THE ONE PLANT MADE WORSE IS THE REAL FLEXIBLE ARM, AND IT IS THE SHAPE RATHER THAN THE SIZE
   (plan §88.3).** What ships there is the CONVENTIONAL rung at 1.93x, and a sharper-edged program

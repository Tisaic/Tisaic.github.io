...
- **The controller, live** — three boxes, none of which recommission, plus a fourth that
  ...
  STALE AT THE SHIPPED LOOP, AND IN THE GOOD DIRECTION (plan §113).** It was measured at §52.19's
  ...
  **AND THE MONOTONE GATE IS NOT WHAT PROTECTS IT, WHICH ITS OWN FALSIFIER SETTLED (plan §113.1).**

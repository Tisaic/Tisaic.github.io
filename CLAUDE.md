...
```
  bend   (§78)    bendGuard = !!o.bendGuard   default FALSE, off on the measurement
  load   (§82)    loadGuard = !!o.loadGuard   default FALSE, off on the measurement
  decl   (§90.4)  no host declares            declSpan null — and §100 measured it costing 2x

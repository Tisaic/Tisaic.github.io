...
and deploys 0.14x, because the forecast's horizon and the QP's are one constant. The next build is
a forecast bank at reachable leads on the raw truth, separated from the QP's horizon.

...
export function makeArmHost(o) {
  ...
  async function distilRuns() {
    ...
    // So two laps, a 500-step hold and four programs ship; the passes and the cap do not move.
    const TEACH_LAPS = o.distilTeachLaps ?? 2;
    const TEACH_HOLD = o.distilTeachHold ?? 500;    // steps held at the program's start before each drive

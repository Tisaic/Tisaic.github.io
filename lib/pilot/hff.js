...
export class HarmonicFF {
  ...
  async commission(run) {
    ...
    rep.damped = fin.damped; rep.stepH = fin.stepH; rep.perHarmonicStep = this.perHarmonicStep;
    rep.sigma = fin.sigma; rep.stopped = fin.stopped; rep.withinNoise = fin.withinNoise;
  ...
  async _refine(run, base, passes, backtracks, amp = 1) {
    ...
    return { best, W: bestW, hist, step: steps, damped, finalStep: fin2, laps,
      stepH: Array.from(stepH), sigma: sigma || null, stopped, withinNoise };
  }
}

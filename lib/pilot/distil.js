...
export class DistilPolicy {
  ...
  act(refAt, k, speed = null, state = null) {
   ...
   */
  actLook(look, speed = null, state = null) {
    if (!this.W || !this.report?.deploy) return new Array(this.channels).fill(0);
  ...
  toJSON() {
    ...
    return {
      ...
      coverageFade: this.coverageFade, online: this.online, stride: this.stride || 1, closed: !!this.closed,

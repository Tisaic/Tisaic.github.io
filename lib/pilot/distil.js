...
export class DistilPolicy {
   ...
   */
  addProgram({ refAt, n, prefix, speedAt, stride = 1, closed = false, stateAt = null }) {
  ...
  act(refAt, k, speed = null, state = null, load = null) {
    ...
    const g = this._coverage(speed) * this._load(load);
   ...
   */
  actLook(look, speed = null, state = null, load = null) {
    if (!this.W || !this.report?.deploy) return new Array(this.channels).fill(0);

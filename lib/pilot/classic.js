...
export function motionBasis(refs, o = {}) {
  const { coulomb = true, bias = true } = o;
  ...
  return {
    ...
    /** the same basis evaluated on ANOTHER trajectory, under THIS normalisation */
    live(v, a) {
...
export class ClassicFF {
  ...
  _sc(W) { if (this._scW !== W) { this._scW = W; this._scV = this._scale(W); } return this._scV; }

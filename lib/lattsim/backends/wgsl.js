...
// 96 bytes. Every vec3<f32> member is 16-byte aligned in WGSL, so the layout is
// omega/forcePre/omegaMinus/csSqr (0,4,8,12) - force (16) - inletVel (32) -
// impulse (48) - impulseCentre (64) with impulseRadius (76) in its trailing
// slot, then magicLambda (80), rounding the struct to 96.

...
export const CELL = Object.freeze({
  ...
  // ---- the elastic regime. Added rather than overloaded: FLUID and SOLID mean
  // specific things to the LBM operator, and a deformable body is neither. The
  // elastic operator reads only these two and treats EVERY other id as vacuum,
  // which is what makes "outside the part" a traction-free surface for free.
  ELASTIC: 5,    // deformable material
  CLAMPED: 6,    // held at zero velocity (a built-in end, a bolted face)
});

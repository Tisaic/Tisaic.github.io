...
// THE PLANT LIVES IN ITS OWN MODULE so a second file can drive the same one — the ensemble work
// commissions this arm k times in ONE process, and the alternative was a second copy of it.
// ------------------------------------------------------------------- ROUTE AND LIMIT

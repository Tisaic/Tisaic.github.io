# LattSim engine — the measurement history

The reference is `lib/lattsim/README.md`; this is the record behind it — the turbulence
study, the limiter, the shedding threshold, the startup transient, the probe's three
defects, the stability tables and the sizing. Where this and the README disagree, the
README is what ships.
